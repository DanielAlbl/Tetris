...
void Game::changeNextShape()
{
    ...
    switch(randNum)
    {
         case 0: nextShape = new TwoXtwo(NEXT_X,NEXT_Y);
            break;
         case 1: nextShape = new OhhJesus(NEXT_X,NEXT_Y);
            break;
         case 2: nextShape = new Chode(NEXT_X,NEXT_Y);
            break;
         case 3: nextShape = new Dick(NEXT_X,NEXT_Y); 
            break;
         case 4: nextShape = new LhDick(NEXT_X,NEXT_Y);
            break;
         case 5: nextShape = new BentDick(NEXT_X,NEXT_Y);
            break;
         case 6: nextShape = new LhBentDick(NEXT_X,NEXT_Y);
            break;
    }
...
void Game::changeShape()
{
    ...
    switch(randNum)
    {
         case 0: currentShape = new TwoXtwo(START_X,START_Y);
            break;
         case 1: currentShape = new OhhJesus(START_X,START_Y);
            break;
         case 2: currentShape = new Chode(START_X,START_Y);
            break;
         case 3: currentShape = new Dick(START_X,START_Y); 
            break;
         case 4: currentShape = new LhDick(START_X,START_Y);
            break;
         case 5: currentShape = new BentDick(START_X,START_Y);
            break;
         case 6: currentShape = new LhBentDick(START_X,START_Y);
            break;
    }
